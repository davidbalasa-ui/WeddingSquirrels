...
export function PlanHero({ session: _session }: { session: SessionAccount }) {
  return (
    <header className="mb-8 pt-5">
      <div className="flex items-start justify-between gap-3">
        <p className="text-[11px] font-semibold uppercase tracking-[0.16em] text-muted">Plan</p>
      ...
      <h1 className="mt-2 font-[family-name:var(--font-display)] text-[2.15rem] leading-[1.05] tracking-tight">
        Everything that gets us to “I do.”
      </h1>
    </header>
  );
}
